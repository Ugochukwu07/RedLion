...
class Database {
    ...
    private function executeQurey($sql, $data) {
...
//$new = new Database;
//print_r($new->create('users', ['idVerification' => 0]));
//print_r($new->selectColInner(['users' => 'id', 'transactions' => 'user_id', 'funds' => 'user_id'], ['users' => 'firstname', 'transactions' => 'trans_id', 'funds' => 'start']));
?>