...
<section class="white-bg o-hidden">
   <div class="container-fluid p-0">
      <div class="row">
        <div class="col-sm-12">
           <div class="owl-carousel" data-items="3" data-md-items="3" data-sm-items="3" data-xs-items="2" data-xx-items="1" data-space="0">
               <div class="item">
                 <img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/detail/big/01.jpg" alt="">
               </div>
               <div class="item">
                 <img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/detail/big/02.jpg" alt="">
               </div>
               <div class="item">
                 <img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/detail/big/03.jpg" alt="">
               </div>
               <div class="item">
                 <img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/detail/big/04.jpg" alt="">
               </div>
               <div class="item">
                 <img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/detail/big/05.jpg" alt="">
               </div>
             </div>
           </div>
        </div>
              ...
              <div class="blog-comments mt-40">
                        <div class="comments-1">
                            <div class="comments-photo">
                                <img src="<?php echo BASE_URL . '/assets/open/'; ?>images/team/08.jpg" alt="">
                            </div>
 ...
 Form -->
  ...
  <div class="row mt-10">
         ...
         <div class="section-title text-center">
               ...
               <style> .section-field{width: 100% !important;}</style>
 ...
 Form -->
         ...
         <div class="col-lg-12 col-md-12">
              ...
              <div class="item">
                <div class="product">
                 <div class="product-image">
                     <img class="img-fluid mx-auto" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/01.jpg" alt="">
           ...
           <div class="item">
                <div class="product">
                 <div class="product-image">
                     <img class="img-fluid mx-auto" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/02.jpg" alt="">
                     <div class="product-overlay">
                       <div class="add-to-cart">
                          <a href="shop-single.html">add to cart</a>
                       </div>
           ...
           <div class="item">
                <div class="product">
                 <div class="product-image">
                     <img class="img-fluid mx-auto" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/03.jpg" alt="">
                     <div class="product-overlay">
                       <div class="add-to-cart">
                          <a href="shop-single.html">add to cart</a>
                       </div>
           ...
           <div class="item">
                <div class="product">
                 <div class="product-image">
                     <img class="img-fluid mx-auto" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/04.jpg" alt="">
                     <div class="product-overlay">
                       <div class="add-to-cart">
                          <a href="shop-single.html">add to cart</a>
                       </div>
           ...
           <div class="sidebar-widgets-wrap">
               ...
               <div class="sidebar-widget mb-40">
                <h5 class="mb-20">Recent items</h5>
                 <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/01.jpg" alt=""></a>
                    </div>
                  ...
                  <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/02.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
                  ...
                  <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/03.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
                ...
                <h5 class="mb-20">Popular items</h5>
                 <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/08.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
                  ...
                  <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/09.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
                  ...
                  <div class="recent-item clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/10.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
                  ...
                  <div class="recent-item mb-0 clearfix">
                    <div class="recent-image">
                        <a href="shop-single.html"><img class="img-fluid" src="<?php echo BASE_URL . '/assets/open/'; ?>images/shop/11.jpg" alt=""></a>
                    </div>
                    <div class="recent-info">
                        <div class="recent-title">
                             <a href="shop-single.html">Product name</a>
