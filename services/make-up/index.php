...
/* $extra = '<!-- Shop -->
<link href="' . BASE_URL . '/assets/open/css/shop.css" rel="stylesheet" type="text/css" />';*/
$title = 'Make Up';
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            preloader -->
            <div id="pre-loader">
                <img src="<?php echo BASE_URL . '/assets/open/'?>images/pre-loader/loader-11.svg" alt="">
            </div>
            <!--=================================
            preloader -->
            ...
            <!--=================================
                ...
                <section class="rev-slider">
                    <div id="rev_slider_32_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="website-intro" data-source="gallery" style="background:#000000;padding:0px;">
                    <!-- START REVOLUTION SLIDER 5.4.6.3 fullscreen mode -->
                    <div id="rev_slider_32_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.6.3">
                    <ul>  <!-- SLIDE  -->
                        <li data-index="rs-83" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="revolution/assets/demo/website-intro/100x50_7f8ce-28.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                            <img src="<?php echo BASE_URL; ?>/assets/open/revolution/assets/demo/website-intro/7f8ce-28.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 500; color: #ffffff; letter-spacing: -5px;font-family:Rubik;">Based On<br/>
                    Bootstrap 4 </div>
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;font-family:Rubik;">We'll do everything we can to make
                    our next best project! </div>

                        <!-- LAYER NR. 17 -->
                        <a class="tp-caption rev-btn  tp-resizeme"
                    href="#" target="_self"       id="slide-83-layer-7"
                        data-x="['center','center','center','center']" data-hoffset="['-2','-2','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['199','199','160','120']"
                                data-width="250"
                        data-height="none"
                        data-whitespace="nowrap"
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: px;font-family:Rubik;text-transform:uppercase;background-color:rgb(132,186,63);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">Discover More  </a>
                    </li>
                    <!-- SLIDE  -->
                        <li data-index="rs-84" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="revolution/assets/demo/website-intro/100x50_005a6-29.jpg"  data-delay="9000"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                            <img src="<?php echo BASE_URL; ?>/assets/open/revolution/assets/demo/website-intro/005a6-29.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        data-responsive_offset="off"
                        data-responsive="off"
                                data-frames='[{"delay":10,"speed":500,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power4.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power4.easeOut"}]'
                                data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]"
                                data-paddingbottom="[0,0,0,0]"
                        ...
                        data-responsive_offset="on"
                                ...
                                data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['center','center','center','center']"
                                data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]"
                                data-paddingbottom="[0,0,0,0]"
                                ...
                                style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 500; color: #ffffff; letter-spacing: -5px;font-family:Rubik;">We Do Things<br/> Differently </div>
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;font-family:Rubik;">We truly care about our users and our product. </div>

                        <!-- LAYER NR. 34 -->
                        <a class="tp-caption rev-btn  tp-resizeme"
                    href="#" target="_self"       id="slide-84-layer-7"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        ...
                        data-responsive_offset="on"
                                ...
                                data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"0","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;fb:0;","style":"c:rgba(255,255,255,1);bs:solid;bw:0 0 0 0;"}]'
                                data-textAlign="['center','center','center','center']"
                                data-paddingtop="[0,0,0,0]"
                                data-paddingright="[50,50,50,50]"
                                data-paddingbottom="[0,0,0,0]"
                                ...
                                style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: px;font-family:Rubik;text-transform:uppercase;background-color:rgb(132,186,63);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">Purchase Now  </a>
                    </li>
                    <!-- SLIDE  -->
                        <li data-index="rs-85" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="revolution/assets/demo/website-intro/100x50_74906-30.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                            <img src="<?php echo BASE_URL; ?>/assets/open/revolution/assets/demo/website-intro/74906-30.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 500; color: #ffffff; letter-spacing: -5px;font-family:Rubik;">Responsive <br/>Framework </div>
                        ...
                        data-responsive_offset="on"
                                ...
                                style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;font-family:Rubik;">We'll do everything we can to make our next best project! </div>

                        <!-- LAYER NR. 51 -->
                        <a class="tp-caption rev-btn  tp-resizeme"
                    href="#" target="_self"       id="slide-85-layer-7"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['200','200','160','120']"
                                data-width="250"
                        data-height="none"
                ...
                <div class="tp-bannertimer tp-bottom" style="height: 5px; background: rgba(87,202,133,1);"></div> </div>
                </div>
                </section>
...
<section class="page-section-pt">
                ...
                <div class="mt-0">
                    <img class="img-fluid mx-auto" src="<?php echo BASE_URL . '/'; ?>assets/open/images/bg/13.png" alt="">
                </div>
            </section>
 ...
 <section class="page-section-ptb">
   <div class="container">
     <div class="row">
         ...
         <div class="mb-10 section-title text-center">
              <h4 class="title-effect">Portfolio Columns 5 </h4></div>
              <div class="isotope columns-3 popup-gallery">
                  <div class="grid-item">
                      <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/01.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/01.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                   </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/02.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/02.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/03.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/03.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                    </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/04.gif" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/04.gif"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/05.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/05.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/06.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/06.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/07.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/07.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/08.gif" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/08.gif"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/09.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/09.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
                  <div class="grid-item">
                   <div class="portfolio-item">
                       <img src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/10.jpg" alt="">
                         <div class="portfolio-overlay">
                            <h4 class="text-white"> <a href="<?php echo BASE_URL . '/services/make-up/sample.php'; ?>"> Your title here </a> </h4>
                          </div>
                        <a class="popup portfolio-img" href="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/10.jpg"><i class="fa fa-arrows-alt"></i></a>
                    </div>
                  </div>
              </div>
            </div>
...
<!--=================================
 ...
 <section class="page-section-ptb" style="background: #ceabf9;">
   <div class="container">
     <div class="row">
        <div class="col-lg-8 mx-auto col-md-8 col-12">
  <div class="row mt-10">
              <div class="col-sm-12">
         <div class="section-title text-center">
               <h2 class="mb-10 title-effect">Request for a Qoute </h2></div>
                <div class="contact-form clearfix">
                   ...
                   <div class="section-field submit-button">
                       ...
                       <button name="submit" type="submit" value="Send" class="button"> Send your message </button>
                   </div>
                  </div>
                </div>
           </div>
 ...
 <section class="page-section">
  ...
  <div class="row mt-30">
        <div class="col-lg-12 section-title text-center">
           <h2 class="mb-10 title-effect">Teams</h2>
        </div>
        <div class="col-lg-3 col-sm-6 sm-mb-30">
           <div class="team team-round-shadow">
              <div class="team-photo">
                <img class="img-fluid mx-auto" src="<?php echo BASE_URL; ?>/assets/open/images/team/01.jpg" alt="">
              </div>
          ...
          <div class="col-lg-3 col-sm-6 sm-mb-30">
           <div class="team team-round-shadow">
              <div class="team-photo">
                <img class="img-fluid mx-auto" src="<?php echo BASE_URL; ?>/assets/open/images/team/02.jpg" alt="">
              </div>
              <div class="team-description">
                <div class="team-info">
          ...
          <div class="col-lg-3 col-sm-6 xs-mb-30">
           <div class="team team-round-shadow">
              <div class="team-photo">
                <img class="img-fluid mx-auto" src="<?php echo BASE_URL; ?>/assets/open/images/team/06.jpg" alt="">
              </div>
              <div class="team-description">
                <div class="team-info">
          ...
          <div class="col-lg-3 col-sm-6">
           <div class="team team-round-shadow">
              <div class="team-photo">
                <img class="img-fluid mx-auto" src="<?php echo BASE_URL; ?>/assets/open/images/team/04.jpg" alt="">
              </div>
              <div class="team-description">
                <div class="team-info">
   ...
   <div class="container">
     ...
     <div class="col-lg-12 col-md-12">
         <div class="section-title">
             <h3 class="mb-10 title-effect"> Recent Works </h3>
            </div>
              <div class="owl-carousel" data-nav-dots="true" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1" data-xx-items="1" data-space="20">
                <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/01.jpg" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/02.jpg" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/03.jpg" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/04.gif" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/05.jpg" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/06.jpg" alt="">
                </div>
                 <div class="item">
                  <img class="img-fluid full-width" src="<?php echo BASE_URL; ?>/assets/open/images/portfolio/small/07.jpg" alt="">
                </div>
             </div>
        </div>
